...
type FileType = Omit<File, "createdAt" | "updatedAt"> & { createdAt: string; updatedAt: string }

interface FileComponentProps {
  file: FileType
  deleteFile: (file: { id: string }) => void
  currentlyDeletingFile: string | null
}

const FileComponent = ({ file, deleteFile, currentlyDeletingFile }: FileComponentProps) => {
  return (
